...
if($cantidadConsulta ==0){ 
    header("Location:olvideMipassword.php?errorEmail=1");
    exit();
}else{
...
$updateClave    = ("UPDATE usuarios SET tokenUser='$miTokenClave' WHERE email='".$correo."' ");
...
$cuerpo .= '
    ...
    if(mail($destinatario,$asunto,$cuerpo,$headers)){
        ...
        header("Location:olvideMipassword.php.php?email=1");
        exit();
    }
