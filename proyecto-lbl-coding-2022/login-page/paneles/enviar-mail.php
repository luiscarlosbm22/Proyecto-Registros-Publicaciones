...
$edad = clean_text($_POST["edad"]);
$nombre = clean_text($_POST["nombre"]);
$email = clean_text($_POST["email"]);
$universidad = clean_text($_POST["universidad"]);
$profesion = clean_text($_POST["profesion"]);
if(isset($_POST["submit"]))
{
	...
	$message = '
		...
		<table border="1" width="100%" cellpadding="5" cellspacing="5">
			...
			<tr>
				<td width="30%">Universidad</td>
				<td width="70%">'.$universidad.'</td>
			</tr>
			<tr>
				<td width="30%">Profesion</td>
				<td width="70%">'.$profesion.'</td>
			</tr>
		</table>
	';
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12" style="margin:0 auto; float:none;">
					<br />
					<h4>Gracias por querer ser parte de nosotros</h4>
                    <hr>
                    <div class="card">
  <h5 class="card-header">Pronto te responderemos</h5>
  <div class="card-body">

<?php echo $message; ?>
  </div><br>
  <a class="btn btn-outline-primary" href="../page-one.php" role="button">Volver</a>
</div>
				</div>
			</div>
		</div>
